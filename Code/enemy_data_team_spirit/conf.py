...
import src.reward as reward_functions

def get(param):
  method_name = 'enemy_data_team_spirit/'
  params = {
    'NAME' : method_name[:-1],

    'AGENT1' : method_name + 'agent.py',
    'AGENT2' : 'enemy_data_team_spirit/place26_epsilon.py',
    'AGENT3' : 'enemy_data_team_spirit/place26_epsilon.py',
    'AGENT2_EPSILON' : 0,
    'AGENT1_EXPLOIT' : method_name + 'exploit.py',
    'SHIP_MODEL' : method_name + 'enemy_data_team_spirit_model',
    ...
    'train_function' : train_functions.train_on_games_enemy_data_team_spirit,
    'reward_function' : reward_functions.team_spirit
    }
