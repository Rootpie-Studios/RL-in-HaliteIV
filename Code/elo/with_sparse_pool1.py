...
ship_model = tf.keras.models.load_model('models/with_sparse_pool1_model')
...
def agent(obs, config):
    ...
    for ship in sorted_ships:
        state, has_nearby_shipyards = input_data.obs_to_matrix_sparse(obs, ship._id, me._id, own_ship_actions)
