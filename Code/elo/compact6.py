...
ship_model = tf.keras.models.load_model('models/compact6_model')
...
def agent(obs, config):
    ...
    for ship in sorted_ships:
        state, has_nearby_shipyards = input_data.obs_to_matrix_six(obs, ship._id, me._id, own_ship_actions, conf.get('size'))
