...
def get(param):
  method_name = 'enemy_data/'
  params = {
    'NAME' : method_name[:-1],

    'AGENT1' : method_name + 'agent.py',
    'AGENT2' : 'enemy_data/place26_epsilon.py',
    'AGENT2_EPSILON' : 0.15,
    'AGENT1_EXPLOIT' : method_name + 'exploit.py',
    'SHIP_MODEL' : method_name + 'enemy_data_model',
    ...
    'train_function' : train_functions.train_on_games_and_enemy_data
    }
