...
import baseline_selfplay.conf as conf
...
plot.plot_progress(10, folder, conf.get('NAME'), conf.get('AGENT2')[:-3], model, conf.get('input_data'), title="baseline_self vs self")